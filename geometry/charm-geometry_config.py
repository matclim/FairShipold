...
with ConfigRegistry.register_config("basic") as c:
    ...
    c.PixelDetector=AttrDict(z0=0* u.cm)
    c.PixelDetector.DimZSi = 0.0200 * u.cm
    ...
    c.PixelDetector.nSilicon = 6
    c.PixelDetector.NPixelModulesperPlane=2
    c.PixelDetector.PX = 4 * u.cm
    c.PixelDetector.PY = 1.68 * u.cm
    c.PixelDetector.PZ = 0.02 * u.cm
    #position of module centres, variable names must be reformatted to [x/y/z]Si_Planenumber
    c.PixelDetector.zSi_0 = c.PixelDetector.PairSiDistance/2. + c.PixelDetector.DimZSi/2. + c.Box.GapPostTargetTh
    ...
    c.Spectrometer.SZ = c.PixelDetector.PZ*2 + c.PixelDetector.zSi_5 - c.PixelDetector.zSi_0 + c.PixelDetector.PairSiDistance + c.PixelDetector.DimZSi + 80 *u.cm + 4.5*u.m #4.5 m is the Goliath length + 80 *u.cm + 4.5*u.m #4.5 m is the Goliath length
   
    c.PixelDetector.DimZSi = c.Box.GapPostTargetTh + c.PixelDetector.zSi_5 - c.PixelDetector.zSi_0 + c.PixelDetector.PairSiDistance + c.PixelDetector.DimZSi
    
    PixeltoGoliath = 30.45 *u.cm #25.45 + 5cm different goliath dz
    c.Spectrometer.zBox = 350.75 - c.Spectrometer.TS/2 - PixeltoGoliath - c.PixelDetector.DimZSi/2.
    c.Box.zBox = c.Spectrometer.zBox - c.PixelDetector.DimZSi/2. 

    #position of SciFis 
    distGoliathSciFi1 = 10*u.cm
    c.Spectrometer.Scifidist = 5 * u.cm   
    c.Spectrometer.zSciFi1 = c.Spectrometer.zBox + c.PixelDetector.DimZSi/2. + PixeltoGoliath + c.Spectrometer.TS + distGoliathSciFi1 +  c.Spectrometer.DZ/2.
    ...
    if c.MufluxSpectrometer.muflux == True:
       ...
       c.MuonTagger.zBox = c.Spectrometer.zBox + c.PixelDetector.DimZSi/2. + PixeltoGoliath + c.Spectrometer.TS + 261*u.cm + c.MuonTagger.BZ/2. #real position of MuonTagger
